 ...
 */
  $.fn.simpleColor = function(options) {
    ...
    var defaultColors = [
        '6e79be','e3528c','e47979','c641de','3e98af', '29ad7d','7755f7',
        '3bc755','d68149','c4a744', 'c7bf41','67bc39','ffffff'
    ];
    ...
    options = $.extend({
      ...
      boxWidth:         this.attr('boxWidth') || '400px',
      boxHeight:        this.attr('boxHeight') || '35px',
